...
const Header = ({props}) => {
  ...
  return (
    <div className='header'>
        <div className={props == "list" ? "header-container listMode" : "header-container"}>
            ...
            <>
                ...
                <p className='headerDesc'>Get rewarder for your travels - unlock instant savings of 10% or more on your first booking</p>
                    ...
                    <div className='headerSearchItem'>
                        ...
                        {openOptions && <div className='options'>
                            ...
                            <div className='option-item'>
                                ...
                                <div className='optionCounter'>
                                    <button 
                                    disabled={options.children <= 0}className='optionCounterBtn'
